  ...
  return (
    <TouchableOpacity onPress={handlePress} activeOpacity={0.7}>
      ...
      <LinearGradient
        ...
        style={{ borderRadius: 24, padding: 5 }} // Remove absolute positioning, add padding for border effect
      >
        {/* Content layer - nested inside gradient */}
        <View className="flex flex-row items-center justify-between gap-1.5 rounded-3xl bg-tertiary p-4">
          <View className="flex flex-col">
            <Text className="font-inter text-lg font-medium text-white">
              Unlock All Features
            </Text>
            <Text className="font-inter text-xs text-white">
              Get access to unlimited chat,{"\n"}advanced ai model, custom
              persona
              {"\n"}selection
            </Text>
          </View>
